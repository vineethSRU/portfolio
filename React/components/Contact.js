const Contact = () => {
  return (
    <section
      id="contact"
      className="contact-area pt-5 pb-5 rpt-70 rpb-100 rel z-1"
  ...
  <span className="sub-title mb-15">Get In Touch</span>
    <h3>
    Let’s Build Your <span>Next-Gen Java Applications</span>
  </h3>
 <p>
  Let’s collaborate to build robust, scalable, and secure full-stack Java applications that drive your business forward.
</p>

</div>
<ul className="list-style-two">
  <li>6+ Months of Experience<br></br> in Full Stack Java Development</li>
  <li>Java, JavaScript, TypeScript,<br></br> SQL, HTML5, CSS3,Bootstrap</li>
  <li>Angular,React.js,Vue.js,<br></br>Next.js,Bootstrap</li>
  <li>Spring MVC, Spring Cloud</li>
</ul>
