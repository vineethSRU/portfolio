...
const items = [
  {
    id: 1,
    name: "Java",
    image: "assets/images/skills/java.jpg",
    value: "95",
  },
  {
    id: 2,
    name: "JavaScript",
    image: "assets/images/skills/javascript.jpeg",
    value: "93",
  },
  {
    id: 3,
    name: "TypeScript",
    image: "assets/images/skills/typeScript.jpg",
    value: "90",
  },
  {
    id: 4,
...
const Skill = () => {
  return (
    <section id="skills" className="skill-area rel z-1">
      <div className="for-bgc-black pt-50 rpt-100 pb-5 rpb-70">
            ...
            <div className="col-lg-5">
              <div className="skill-content-part rel z-2 rmb-55 wow fadeInUp delay-0-2s">
                <div className="section-title mb-40">
                  ...
                  <h2>
  Java Full Stack  <span>Engineering Skill Set</span>
</h2>
<p>
  My expertise lies in building robust, scalable, and secure full stack applications using Java, Spring Boot, and modern JavaScript frameworks like Angular and React. 
  I design RESTful APIs, architect microservices, integrate CI/CD pipelines, and deploy applications to cloud platforms such as AWS and Azure. 
  I ensure code quality, performance, and security across the entire development lifecycle.
</p>
