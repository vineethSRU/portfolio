...
const Projects = () => {
  return (
   <section
  id="portfolio"
  className="projects-area pt-130 rpt-100 pb-0 rpb-20 rel z-1"
>
      <div id="getinTouch" className="container">
  ...
  <div className="col-lg-6">
    <div className="project-image wow fadeInLeft delay-0-2s">
      <img
      id="project11"
        src="assets/images/projects/project_2.png"
        alt="Project"
  ...
  <div className="col-xl-5 col-lg-6">
    <div className="project-content wow fadeInRight delay-0-2s">
      <span className="sub-title">Delivery Management System</span>
      <h2>
      ...
      <p>
       Developed a full-stack web application using React.js, Spring Boot, and MySQL to manage end-to-end
delivery operations. Customers can place orders through a user-friendly interface; admins manage and assign
orders to delivery personnel. Delivery staff update order statuses, which are reflected in real-time to both
...
<div className="row align-items-center pb-5">
  <div className="col-lg-6 order-lg-2">
    <div className="project-image wow fadeInLeft delay-0-2s">
      <img
         id="WorkflowImg"
        src="assets/images/projects/project_1.png"
        alt="Project"
        className="w-full h-32 object-cover object-top rounded-lg shadow"
      />
    </div>
  </div>
  <div className="col-xl-5 col-lg-6 ms-auto">
    <div className="project-content wow fadeInRight delay-0-2s">
      <span className="sub-title">Insurance Company Application</span>
      <h2>
        <Link legacyBehavior href="project-details">
      ...
      <p>
Developed and maintained user-facing features using React.js, improving UI responsiveness and usability for
policy management and claims tracking.
Collaborated with backend team to build and consume RESTful APIs using Spring Boot, handling user
authentication, policy details, and payment integration.
      </p>
