...
const Footer1 = () => {
  ...
  return (
    <footer className="main-footer rel z-1">
      <div className="footer-top-wrap bgc-black pt-5
       pb-5">
        <div className="container">
          <div className="row">
            <div className="col-lg-2 col-md-12 pt-30">
 ...
 <Link legacyBehavior href="/">
  ...
  >
    THALLAPALLY <span style={{ color: "#d5ff00" }}>VINEETH</span>
  </a>
</Link>
</div>
            ...
            <div className="col-lg-7 col-md-7">
              <div className="footer-widget widget_nav_menu wow fadeInUp delay-0-4s text-center">
                ...
                <ul>
                  <li>
                    <Link legacyBehavior href="https://linkedin.com/in/vineeth-thallapally">
  ...
  Download CV
            ...
            <div className="col-lg-3 col-md-5">
              <div className="footer-widget widget_contact_info wow fadeInUp delay-0-6s pt-20 ">
                <h6 className="footer-title">Address</h6>
                <ul>
                  <li>
                    <i className="far fa-map-marker-alt" /> Hyderabad ,INDIA <br></br>
                  ...
                  <li>
                    ...
                    <a href="callto:+880(123)45688">+91 9704373531</a>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div className="footer-bottom pt-0 pb-5 rpt-25">
        <div className="container">
          <div className="row">
    ...
    <footer className="main-footer footer-two pt-75 rel z-1">
      <div className="container">
        <div className="row align-items-center justify-content-between">
          <div className="col-lg-3 col-md-5">
            <div className="footer-widget widget_logo text-center text-md-start wow fadeInUp delay-0-2s pt-20">
              <div className="footer-logo">
                <Link legacyBehavior href="/">
                  <a
      style={{
